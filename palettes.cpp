...
DEFINE_GRADIENT_PALETTE(es_vintage_57_gp){
    0, 2, 1, 1, 53, 18, 1, 0, 104, 69, 29, 1, 153, 167, 135, 10, 255, 46, 56, 4
};
...
DEFINE_GRADIENT_PALETTE(BlacK_Blue_Magenta_White_gp){
    0, 0, 0, 0, 42, 0, 0, 45, 84, 0, 0, 255, 127, 42, 0, 255, 170, 255, 0, 255, 212, 255, 55, 255, 255, 255, 255, 255
};
...
#define _GRADIENT_ROW(id)                                                                                              \
    {                                                                                                                  \
#id, id                                                                                                        \
    }

const StaticGradient gGradientPalettes[] = { _GRADIENT_ROW(Sunset_Real_gp),
                                             _GRADIENT_ROW(es_rivendell_15_gp),
                                             _GRADIENT_ROW(es_ocean_breeze_036_gp),
                                             _GRADIENT_ROW(rgi_15_gp),
                                             _GRADIENT_ROW(retro2_16_gp),
                                             _GRADIENT_ROW(Analogous_1_gp),
                                             _GRADIENT_ROW(es_pinksplash_08_gp),
                                             _GRADIENT_ROW(Coral_reef_gp),
                                             _GRADIENT_ROW(es_ocean_breeze_068_gp),
                                             _GRADIENT_ROW(es_pinksplash_07_gp),
                                             _GRADIENT_ROW(es_vintage_01_gp),
                                             _GRADIENT_ROW(departure_gp),
                                             _GRADIENT_ROW(es_landscape_64_gp),
                                             _GRADIENT_ROW(es_landscape_33_gp),
                                             _GRADIENT_ROW(rainbowsherbet_gp),
                                             _GRADIENT_ROW(gr65_hult_gp),
                                             _GRADIENT_ROW(gr64_hult_gp),
                                             _GRADIENT_ROW(GMT_drywet_gp),
                                             _GRADIENT_ROW(ib_jul01_gp),
                                             _GRADIENT_ROW(es_vintage_57_gp),
                                             _GRADIENT_ROW(ib15_gp),
                                             _GRADIENT_ROW(Fuschia_7_gp),
                                             _GRADIENT_ROW(es_emerald_dragon_08_gp),
                                             _GRADIENT_ROW(lava_gp),
                                             _GRADIENT_ROW(fire_gp),
                                             _GRADIENT_ROW(Colorfull_gp),
                                             _GRADIENT_ROW(Magenta_Evening_gp),
                                             _GRADIENT_ROW(Pink_Purple_gp),
                                             _GRADIENT_ROW(es_autumn_19_gp),
                                             _GRADIENT_ROW(BlacK_Blue_Magenta_White_gp),
                                             _GRADIENT_ROW(BlacK_Magenta_Red_gp),
                                             _GRADIENT_ROW(BlacK_Red_Magenta_Yellow_gp),
                                             _GRADIENT_ROW(Blue_Cyan_Yellow_gp) };

const size_t gGradientPaletteBytes =
    sizeof(Sunset_Real_gp) + sizeof(es_rivendell_15_gp) + sizeof(es_ocean_breeze_036_gp) + sizeof(rgi_15_gp) +
    sizeof(retro2_16_gp) + sizeof(Analogous_1_gp) + sizeof(es_pinksplash_08_gp) + sizeof(Coral_reef_gp) +
    sizeof(es_ocean_breeze_068_gp) + sizeof(es_pinksplash_07_gp) + sizeof(es_vintage_01_gp) + sizeof(departure_gp) +
    sizeof(es_landscape_64_gp) + sizeof(es_landscape_33_gp) + sizeof(rainbowsherbet_gp) + sizeof(gr65_hult_gp) +
    sizeof(gr64_hult_gp) + sizeof(GMT_drywet_gp) + sizeof(ib_jul01_gp) + sizeof(es_vintage_57_gp) + sizeof(ib15_gp) +
    sizeof(Fuschia_7_gp) + sizeof(es_emerald_dragon_08_gp) + sizeof(lava_gp) + sizeof(fire_gp) + sizeof(Colorfull_gp) +
    sizeof(Magenta_Evening_gp) + sizeof(Pink_Purple_gp) + sizeof(es_autumn_19_gp) +
